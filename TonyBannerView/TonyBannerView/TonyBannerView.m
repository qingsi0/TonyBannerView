...
#import "TonyBannerView.h"


#pragma mark - TonyImageView
@interface TonyImageView : UIImageView
...
@interface TonyBannerView () <UIScrollViewDelegate>
/** 滚动视图 */
...
- (void)setup
{
    ...
    for (int i = 0; i < imagesCount; i++) {
        TonyImageView *imageView = [[TonyImageView alloc] initWithFrame:CGRectMake(i * SLBannerViewWidth, 0, SLBannerViewWidth, SLBannerViewHeight)];
...
- (void)layoutSubviews
{
    ...
    for (int i = 0; i < imagesCount; i++) {
        TonyImageView *imageView = self.scrollView.subviews[i];
    ...
    TonyImageView *imageView = self.scrollView.subviews[0];
...
{
    TonyImageView *imageView = [[TonyImageView alloc] initWithFrame:self.bounds];
...
- (void)setupContent
{
    ...
    for (int i = 0; i < self.scrollView.subviews.count; i++) {
        ...
        imageView.tag = index;
        //异步优化图片设置
        [imageView asynSetImage:self.slImages[index] placeholderImage:_placeholderImg];
...
{
    TonyImageView *imageView = (TonyImageView *)tap.view;
